<?php include( TEMPLATEPATH . '/property-dash/student-dash/student-dash-header.php' ); ?>
		<div id="wrap" class="jbasewrap">
			...
			<?php
				...
				$submitted_to_paragon = $current_user->submitted_to_paragon;
			...
			<div id="modules">
				<?php
				include( TEMPLATEPATH . '/property-dash/student-dash/modules/progress.php' );
				if ($progress_step == 1) {
		 			include( TEMPLATEPATH . '/property-dash/student-dash/modules/future-viewings.php' ); 
		 			include( TEMPLATEPATH . '/property-dash/student-dash/modules/past-viewings.php' );
		 		}
		 		?>
