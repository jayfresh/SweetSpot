<?php
	...
	*/
	...
	if ($paid_holding_deposit) {
		$progress_step = 2;
		// TO-DO: in Phase IX, change below to:
		// if($paid_security_deposit && $submitted_housemate_info && $submitted_guarantor_info && $submitted_to_paragon && $set_up_DD) {
		$approved_for_step_3 = FALSE;
		if($is_lead_tenant) { // only the lead tenant needs to have submitted_housemate_info
...
<div class="module">
					...
					<div>
						<div id="progressPanel" class="grid6col left">
							...
							<p<?php echo $progress_step==3 ? ' class="current"' : ''; ?>>You're almost there! We're preparing your <a href="#ast" rel="self">tenancy agreement</a> for you to sign.</p><?php //TO-DO: in Phase IX, update text ?>
