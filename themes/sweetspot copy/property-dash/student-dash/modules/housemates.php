...
if ($_POST && $_POST['submit_housemates']) :
	$welcome_email_text = "Hello there! You've been added as a tenant to property XXXXX. Please come and get started with the moving-in process.\n\nLogin at: http://sweetspot.com/property/dash"; // TO-DO: get this into an admin screen
						...
						<form id="housemateDetails" method="POST">
							<div class="housemateDetails">
								...
								<div class="housemateForm">
									...
									<div class="grid2col left marginleft postcode">
									...
									<div class="grid2col left marginleft">
										...
										<input class="required email" type="text" name="email" id="email" readonly="readonly" value="<?php echo $current_user->user_email; ?>" /> <?php // TO-DO: debug! ?>
										<!-- <label for="name" generated="true" class="error">This field is required.</label> -->
									</div>
